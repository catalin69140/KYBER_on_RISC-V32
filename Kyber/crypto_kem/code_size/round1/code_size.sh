...
${CROSS_PREFIX}-gcc -O3 -fno-common -o precomp.o  -c precomp.c

#asm
${CROSS_PREFIX}-gcc -O3 -fno-common -o ntt.o      -c ntt_1.S
${CROSS_PREFIX}-gcc -O3 -fno-common -o invntt.o   -c invntt_1.S
